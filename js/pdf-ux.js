$(document).ready(function () {
  try {
    ...
    let zipLevel = "";
    let baseUrlSection = "/ko-kr/cloud-volumes-ontap-9100-relnotes/pdfs/sidebar/";
    let zipFilename = "";
    let zipFileSize = 0;
    zipLevel = zipLevel !== ""?zipLevel:1;
    zipFilename = zipFilename !== ''?zipFilename:"cloud-volumes-ontap-9100-relnotes.ko-kr.zip";
